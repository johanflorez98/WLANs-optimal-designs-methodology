...
% Current scenario:
scen = 68;
amo_scen = 68; % Number of scenarios availables************************

% AP Positions per scenario:
pos = 46; % Number of simulations to be carried out per scenario
pos1 = 46; % Counter of AP positions per scenario

amo_AP = 4; % Amount of AP************************************************
simulation = "4AP";
